...
function guardexpert_register_shipping_fields() {
	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			...
			array(
				'key'   => 'field_shipping_process_items',
				'label' => 'Шаги процесса',
				'name'  => 'shipping_process_items',
				'type'  => 'repeater',
				'layout' => 'table',
				...
				'sub_fields' => array(
					array(
						'key'   => 'field_shipping_process_item_icon',
						'label' => 'Иконка',
						'name'  => 'icon',
						'type'  => 'image',
						'return_format' => 'url',
						'preview_size' => 'thumbnail',
						'instructions' => 'Изображение иконки. Если не загружено, используется Lucide-иконка по умолчанию.',
					),
					array(
						'key'   => 'field_shipping_process_item_title',
					...
					array(
						'key'   => 'field_shipping_process_item_description',
						'label' => 'Описание шага',
						'name'  => 'description',
						'type'  => 'textarea',
						'required' => 1,
