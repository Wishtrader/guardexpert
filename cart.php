		...
		<div class="grid lg:grid-cols-3 gap-6">
			...
			<div class="lg:col-span-2 space-y-4">
				...
				<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pt-4">
					<a href="<?php echo esc_url( wc_get_page_permalink( 'shop' ) ); ?>" class="text-gray-900 font-medium hover:text-[#B22234] transition underline">
						Продолжить покупки
					</a>
				...
				<div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm sticky top-4">
					...
					<div class="space-y-4 mb-6">
						<div class="flex justify-between items-center pb-4 border-b border-gray-200">
							<span class="text-gray-700">Товары (<?php echo WC()->cart->get_cart_contents_count(); ?>)</span>
							<span class="font-bold text-gray-900 text-lg"><?php echo WC()->cart->get_cart_subtotal(); ?></span>
						</div>
						<div class="flex justify-between items-center pb-4 border-b border-gray-200">
						...
						<div class="flex justify-between items-center">
							...
							<span class="font-bold text-[#B22234] text-xl"><?php echo WC()->cart->get_total(); ?></span>
						</div>
					</div>
